import { ChevronRight, CircleUserRound, GitCompareArrows, Languages, LogIn, ReceiptText, ShieldCheck, ShoppingBag, Sparkles } from "lucide-react";
import { useTranslation } from "../i18n";
import type { User } from "../types";

export function ProfileScreen({ user, cartCount, wardrobeCount, compareCount, onAuth, onLogout, onOrders }: { user: User | null; cartCount: number; wardrobeCount: number; compareCount: number; onAuth: () => void; onLogout: () => void; onOrders: () => void }) {
