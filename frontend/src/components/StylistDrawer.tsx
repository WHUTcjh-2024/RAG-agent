...
import type { DecisionCard, Message, Slots, ToolTrace } from "../types";
import { ChatPanel } from "./ChatPanel";
import { InsightPanel } from "./InsightPanel";
import { useTranslation } from "../i18n";

type Props = { open: boolean; onClose: () => void; messages: Message[]; streaming: boolean; slots: Slots; traces: ToolTrace[]; decision: DecisionCard | null; onSubmit: (message: string, image: File | null, preview: string | null) => void };

export function StylistDrawer({ open, onClose, messages, streaming, slots, traces, decision, onSubmit }: Props) {
