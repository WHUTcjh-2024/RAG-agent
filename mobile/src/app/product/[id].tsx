  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Pressable onPress={() => router.push(`/try-on/${encodeURIComponent(product.article_id)}`)} style={styles.tryOnLaunch}>
          <Plus size={16} color={colors.white} /><Text style={styles.tryOnLaunchText}>AI 虚拟试穿</Text>
        </Pressable>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  tryOnLaunch: { height: 46, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, marginHorizontal: 16, marginTop: 12, borderRadius: radius.md, backgroundColor: colors.primary }, tryOnLaunchText: { color: colors.white, fontSize: 12, fontWeight: "800" },
});
