...
export interface TryOnFeedback {
  rating: number;
  issues: ("BODY_PROPORTION" | "GARMENT_DETAIL" | "MATERIAL" | "COLOR" | "OCCLUSION" | "OTHER")[];
}
...
export interface VirtualTryOnJob {
  ...
  model: { kind: "SYNTHETIC_ADULT"; body_profile: SyntheticBodyProfile; uses_person_photo: false };
